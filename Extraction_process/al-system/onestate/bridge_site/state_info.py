...
if len(argv) != 3 or '-h' in argv:
    ...
    if argv[1] != '-all':
        ...
        path = '/home/maiihn/code/eon/calculation/al-system/onestate/bridge_site'
        newpath = '/home/maiihn/code/eon/calculation/al-system/onestate/bridge_site/OUTPUT/' + str(pathway) + '/state'
