...
if len(argv) != 3 or '-h' in argv:
    ...
    if argv[1] != '-all':
        ...
        for i in range(num_state):
            ...
            state = i
            thepath = '/home/maiihn/code/eon/calculation/al-system/onestate/hollow_site/' + str(state) + '/' + str(pathway) + '/states/'
            thenewpath = '/home/maiihn/code/eon/calculation/al-system/onestate/hollow_site/OUTPUT/' + str(pathway) + '/result'
