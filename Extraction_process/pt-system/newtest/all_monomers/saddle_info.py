...
if len(argv) != 3 or '-h' in argv:
    ...
    if argv[1] != '-all':
        ...
        for i in range(num_state):
            ...
            state = i
            thepath = '/home/maiihn/code/eon/calculation/pt-system/newtest/all_monomers/' + str(state) + '/' + str(pathway) + '/states/'
            thenewpath = '/home/maiihn/code/eon/calculation/pt-system/newtest/all_monomers/OUTPUT/' + str(pathway) + '/result'
