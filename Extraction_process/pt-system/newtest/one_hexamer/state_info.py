...
if len(argv) != 3 or '-h' in argv:
    ...
    if argv[1] != '-all':
        ...
        path = '/home/maiihn/code/eon/calculation/pt-system/newtest/one_hexamer'
        newpath = '/home/maiihn/code/eon/calculation/pt-system/newtest/one_hexamer/OUTPUT/' + str(pathway) + '/state'
