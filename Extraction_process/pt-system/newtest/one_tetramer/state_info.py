...
if len(argv) != 3 or '-h' in argv:
    ...
    if argv[1] != '-all':
        ...
        path = '/home/maiihn/code/eon/calculation/redo-pt-system-1/newtest/one_tetramer'
        newpath = '/home/maiihn/code/eon/calculation/redo-pt-system-1/newtest/one_tetramer/OUTPUT/' + str(pathway) + '/state'
        ...
        for m in method_lst:
            ...
            path = '/home/maiihn/code/eon/calculation/pt-system/newtest/one_tetramer'
            newpath = '/home/maiihn/code/eon/calculation/pt-system/newtest/one_tetramer/OUTPUT/' + str(pathway) + '/state'
