...
if len(argv) != 3 or '-h' in argv:
    ...
    if argv[1] != '-all':
        ...
        path = '/home/maiihn/code/eon/calculation/pt-system/newtest/one_trimer'
        newpath = '/home/maiihn/code/eon/calculation/pt-system/newtest/one_trimer/OUTPUT/' + str(pathway) + '/state'
